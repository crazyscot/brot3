...
<div id="bottombar">
  ...
  <form id="form_go_to_position">
    <table>
      ...
      <tr class="position-entry"><td rowspan="3"><span class="close" id="close-entry">&times;</span></td> <th>Origin:</th><td><input type="text" id="enter_originReal" /></td><td>+ <input type="text" id="enter_originImag" /> i</td><td colspan="3"/></tr>
